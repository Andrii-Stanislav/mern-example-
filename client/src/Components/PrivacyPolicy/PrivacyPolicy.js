...
function PrivacyPolicy({ onMount }) {
  useEffect(() => {
    onMount()
  }, [onMount])
  ...
  return (
    <div className={styles.main}>
      <p>Updated 17th Oct, 2020</p>
      <p>
        Thank you for choosing to be part of our community at QwertyFaceMedia,
        LLC , doing business as ELM CONNECT and CloudKii™ Partnerships
        ("CloudKii™", "we", "us", "our"). We are committed to protecting your
        ...
        support@qwertyface.media. When you visit our website{' '}
        <a
        ...
        includes our Website), as well as, any related services, sales,
      ...
      <ol className={styles.darkBlue}>
        ...
        <li>
          <b>WHO WILL YOUR INFORMATION BE SHARED WITH?</b>
        </li>
        <li>
        ...
        <li>
          <b>IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</b>
        </li>
        <li>
      ...
      <ol>
        <li>
          ...
          <p>
            ...
            collect may include the following: Personal Information Provided by
            You.
          </p>
          <p>
            We collect names; phone numbers; email addresses; contact
            preferences; billing addresses; debit/credit card numbers; and other
          ...
          <p>All payment data is stored by Stripe and PayPal.</p>
          <p>
          ...
          <p>
            ...
            personal information.Information automatically collected In Short:
          ...
          <p>The information we collect includes:Device Data.</p>
          <p>
        ...
        <li>
          ...
          <p>
            ...
            andrew@qwertyface.media and be sure to include your name,
          ...
          <p>
            ...
            secure (for example, for fraud monitoring and prevention).To enforce
            our terms, conditions and policies for business purposes, to comply
            with legal and regulatory requirements or in connection with our
            ...
            the data we hold to determine how to respond. Fulfill and manage
            ...
            participate in our competitions. To deliver and facilitate delivery
            of services to the user. We may use your information to provide you
          ...
          <p>Deliver targeted advertising to you.</p>
          <p>
            ...
            effectiveness.For other business purposes.
          </p>
          <p>
            ...
            improve our Website, products, marketing and your experience. We may
        ...
        <li>
          ...
          <p>
            ...
            specific purpose.Legitimate Interests: We may process your data when
          ...
          <p>
            ...
            information unless we have instructed them to do it. They will also
            not share your personal information with any organization apart from
            us. They also commit to protect the data they hold on our behalf and
        ...
        <li>
          ...
          <p>
            We have categorized each party so that you may be easily understand
            the purpose of our data collection and processing practices.
          </p>
          <p>
            ...
            THIS NOTICE?". Advertising, Direct Marketing, and Lead Generation
            Google AdSense and Facebook Audience Network Allow Users to Connect
            to Their Third-Party Accounts Facebook account Communicate and Chat
            with Users Facebook Customer Chat and Live Chat Content Optimization
            Facebook Live Stream Invoice and Billing Stripe and Paypal
            Retargeting Platforms Facebook Custom Audience and Google Ads
            Remarketing Social Media Sharing and Advertising Facebook social
            plugins User Commenting and Forums Facebook Comments.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            ...
            about you. Our Website offers you the ability to register and login
        ...
        <li>
          ...
          <p>
            ...
            your personal information for longer than sixty (60) months past the
            termination of the user's account. When we have no ongoing
        ...
        <li>
          ...
          <p>
            ...
            contact us at andrew@qwertyface.media.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            email us at support@qwertyface.media.Account Information If you
        ...
        <li>
          ...
          <p>
            ...
            in the past twelve (12) months: Category Examples Collected A.
            ...
            listed in the California Customer Records statuteName, contact
          ...
          <p>
            ...
            lawGender and date of birth NO
          </p>
          <ol type="A">
            <li>
              <p>
                Commercial informationTransaction information, purchase history,
                financial details and payment information NO
              </p>
            </li>
            <li>
              <p>Biometric informationFingerprints and voiceprints NO </p>
            </li>
            <li>
              <p>
                Internet or other similar network activityBrowsing history,
            ...
            <li>
              <p>Geolocation dataDevice location NO </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                details in order to provide you our services at a business
            ...
            <li>
              <p>
                ...
                drawn from any of the collected personal information listed
                above to create a profile or summary about, for example, an
                individual’s preferences and characteristics YES We may also
                ...
                phone or mail in the context of:Receiving help through our
                customer support channels;Participation in customer surveys or
                contests; and Facilitation in the delivery of our Services and
                to respond to your inquiries.How do we use and share your
                personal information? QwertyFace Media, LLC collects and shares
                your personal information through:Beacons/Pixels/Tags More
                information about our data collection and sharing practices can
                be found in this privacy notice. You may contact us by email at
                support@qwertyface.media,{' '}
                <a
                  href="https://www.elmconnect.app/support"
                  rel="noreferrer nofollow"
                  target="_blank"
                >
                  https://www.elmconnect.app/support
                </a>{' '}
                , or by referring to the contact details at the bottom of this
                document. If you are using an authorized agent to exercise your
                right to opt-out we may deny a request if the authorized agent
                does not submit proof that they have been validly authorized to
                act on your behalf. Will your information be shared with anyone
                else? We may disclose your personal information with our service
          ...
          <p>
            ...
            "selling" of your personal data. QwertyFaceMedia, LLC has disclosed
            ...
            months: Category B. Personal information, as defined in the
          ...
          <p>
            ...
            to know Depending on the circumstances, you have a right to
            ...
            which the collected personal information is used;whether we sell
            your personal information to third parties;the categories of
            ...
            information was sold or disclosed for a business purpose; andthe
            ...
            Exercise of a Consumer’s Privacy Rights We will not discriminate
          ...
          <p>
            ...
            we have the information in our system.
          </p>
          <p>
          ...
          <p>
            ...
            personal data you may request correction of your personal data if it
            is incorrect or no longer relevant, or ask to restrict the
            processing of the data you can designate an authorized agent to make
            ...
            CCPA. You may request to opt-out from future selling of your
            ...
            but no later than 15 days from the date of the request submission.To
        ...
        <li>
          ...
          <p>
            ...
            our Data Protection Officer (DPO), Andrew Neumann, by email at
            andrew@qwertyface.media, by phone at 2188516329, or by post to:
            QwertyFaceMedia, LLC Andrew Neumann 721 Allen drive Grand Rapids, MN
            55744 United States
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            please visit: https://www.elmconnect.app/support. We will respond to
